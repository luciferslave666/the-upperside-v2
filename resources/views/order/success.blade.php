...
<body class="bg-gray-100 min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden text-brand-black">
    ...
    <div class="max-w-xl w-full relative z-10">
        <div class="bg-white border-4 border-black shadow-retro p-8 sm:p-10 relative text-center">
            ...
            <p class="font-bold text-gray-500 mb-8">
                Terima kasih, pesananmu sudah masuk.
            </p>

            <!-- TICKET -->
            <div
                class="ticket-animate bg-brand-black text-white p-6 border-4 border-black mb-10 shadow-[8px_8px_0px_0px_#DFFF4F] relative mx-auto max-w-sm">
                <div
                    class="absolute -left-2 top-1/2 -translate-y-1/2 w-4 h-4 bg-white rounded-full border-2 border-black">
                </div>
                <div
                    class="absolute -right-2 top-1/2 -translate-y-1/2 w-4 h-4 bg-white rounded-full border-2 border-black">
                </div>

                <p class="font-display text-sm uppercase tracking-widest text-brand-yellow mb-2">
                    NOMOR PESANAN
                </p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 text-left">
                ...
                <div class="bg-white border-2 border-black p-4 shadow-retro-sm sm:col-span-2">
                    <div class="flex items-center gap-3 mb-1">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    ...
                    <p class="font-display text-lg mt-1">
            ...
            <div class="bg-brand-purple border-2 border-black p-6 text-white text-left relative overflow-hidden">
                <h4 class="font-display text-lg uppercase mb-4 flex items-center gap-2">
                    <span
                        class="bg-brand-yellow text-black w-6 h-6 flex items-center justify-center text-sm border border-black">!</span>
                    Langkah Selanjutnya
                </h4>

                <ul class="space-y-3 font-medium text-sm">
                    <li class="flex items-start gap-3">
                        <span class="font-display text-brand-yellow text-lg">1.</span>
                        <span>Pergi ke kasir & tunjukkan <strong
                                class="text-brand-yellow underline">Nomor Pesanan</strong>.</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="font-display text-brand-yellow text-lg">2.</span>
                        <span>Lakukan pembayaran sesuai total tagihan.</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="font-display text-brand-yellow text-lg">3.</span>
            ...
            <div class="mt-8 pt-6 border-t-2 border-dashed border-gray-300">
                ...
                <div class="mt-6">
                    <a href="/"
                        class="inline-block px-6 py-3 bg-white border-2 border-black font-bold uppercase hover:bg-black hover:text-white transition-colors">
                        Kembali ke Menu
                    </a>
                </div>
            </div>
